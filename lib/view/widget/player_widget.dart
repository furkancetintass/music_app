              ...
              children: [
                  ...
                  onTap: () {
                    setState(() {
                      ...
                      if (globalIndex != 0) {
                        ...
                        globalIndex = Constants.offlineSongs.length - 1;
                      }
                      songName = Constants.offlineSongs[globalIndex];
                      audioProvider.playAudio(
                          'musics/${Constants.offlineSongs[globalIndex]}.mp3',
                          globalIndex);
                ...
                GestureDetector(
                  onTap: () {
                    ...
                    setState(() {
                      if (globalIndex != Constants.offlineSongs.length - 1) {
                        globalIndex = globalIndex + 1;
                      } else {
                        globalIndex = 0;
                      }
